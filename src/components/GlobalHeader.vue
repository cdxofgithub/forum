<template>
  <nav class="navbar navbar-dark bg-primary justify-content-between mb-4 px-4">
    ...
    <ul v-if="!user.isLogin" class="list-inline mb-0">
      <li class="list-inline-item"><router-link to="/" class="btn btn-outline-light my-2">登陆</router-link></li>
    ...
    <ul v-else class="list-inline mb-0">
      <dropdown :title="`你好 ${user.name}`">
          ...
          <dropdown-item><router-link to="/" class="dropdown-item">我的专栏</router-link></dropdown-item>
